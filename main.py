...
def add_item():
    ...
    tk.Button(
        ...
        command=lambda: addition(item_entry.get().lower(), input_validation(quantity_entry.get()), add_item_window)
...
def subtract_item():
    ...
    tk.Button(
        ...
        command=lambda: subtraction(item_entry.get().lower(), input_validation(quantity_entry.get()), subtract_item_window)
    ).grid(row=4, column=1, padx=2, pady=10)
